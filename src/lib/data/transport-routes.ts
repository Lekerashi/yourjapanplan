...
export const TRANSPORT_ROUTES: TransportRoute[] = [
  // Tokyo connections
  { from_slug: "tokyo", to_slug: "kyoto", from_name: "Tokyo", to_name: "Kyoto", primary_method: "Tokaido Shinkansen", duration: "2h 15m", cost_jpy: 13320, cost_display: "~¥13,320", jr_pass_covered: true, tip: "Take Nozomi for fastest (not JR Pass), Hikari for JR Pass holders" },
  { from_slug: "tokyo", to_slug: "osaka", from_name: "Tokyo", to_name: "Osaka", primary_method: "Tokaido Shinkansen", duration: "2h 30m", cost_jpy: 13870, cost_display: "~¥13,870", jr_pass_covered: true, tip: "Shin-Osaka station — transfer to local lines for Namba/Dotonbori" },
  { from_slug: "tokyo", to_slug: "hiroshima", from_name: "Tokyo", to_name: "Hiroshima", primary_method: "Tokaido/Sanyo Shinkansen", duration: "4h", cost_jpy: 18380, cost_display: "~¥18,380", jr_pass_covered: true, tip: "Long ride — reserve a window seat on the right side for Mt. Fuji views" },
  { from_slug: "tokyo", to_slug: "kanazawa", from_name: "Tokyo", to_name: "Kanazawa", primary_method: "Hokuriku Shinkansen", duration: "2h 30m", cost_jpy: 14380, cost_display: "~¥14,380", jr_pass_covered: true, tip: null },
  { from_slug: "tokyo", to_slug: "sendai", from_name: "Tokyo", to_name: "Sendai", primary_method: "Tohoku Shinkansen", duration: "1h 30m", cost_jpy: 11210, cost_display: "~¥11,210", jr_pass_covered: true, tip: null },
  ...
  { from_slug: "tokyo", to_slug: "nagoya", from_name: "Tokyo", to_name: "Nagoya", primary_method: "Tokaido Shinkansen", duration: "1h 40m", cost_jpy: 10560, cost_display: "~¥10,560", jr_pass_covered: true, tip: null },
  ...
  { from_slug: "tokyo", to_slug: "fukuoka", from_name: "Tokyo", to_name: "Fukuoka", primary_method: "Tokaido/Sanyo Shinkansen", duration: "5h", cost_jpy: 22220, cost_display: "~¥22,220", jr_pass_covered: true, tip: "Consider flying (~2h, often cheaper). JR Pass makes Shinkansen worthwhile" },
  ...
  { from_slug: "kyoto", to_slug: "hiroshima", from_name: "Kyoto", to_name: "Hiroshima", primary_method: "Sanyo Shinkansen", duration: "1h 40m", cost_jpy: 10440, cost_display: "~¥10,440", jr_pass_covered: true, tip: null },
  ...
  { from_slug: "osaka", to_slug: "hiroshima", from_name: "Osaka", to_name: "Hiroshima", primary_method: "Sanyo Shinkansen", duration: "1h 30m", cost_jpy: 10010, cost_display: "~¥10,010", jr_pass_covered: true, tip: null },
  ...
  { from_slug: "osaka", to_slug: "fukuoka", from_name: "Osaka", to_name: "Fukuoka", primary_method: "Sanyo Shinkansen", duration: "2h 30m", cost_jpy: 15400, cost_display: "~¥15,400", jr_pass_covered: true, tip: null },
  ...
  // Hiroshima / Chugoku
  { from_slug: "hiroshima", to_slug: "fukuoka", from_name: "Hiroshima", to_name: "Fukuoka", primary_method: "Sanyo Shinkansen", duration: "1h", cost_jpy: 8290, cost_display: "~¥8,290", jr_pass_covered: true, tip: null },
